	...
	<h2>${bvo.writer }의 게시글</h2>
		...
		<table>
			<tbody>
				...
				<tr>
					<td colspan="4" id = "btn">
						<input type="button" value="게시글 수정" onclick="location.href='/chapter20_mvc_bbs/BBSController?cmd=update_page'">
						<input type="button" value="게시글 삭제" onclick="location.href='/chapter20_mvc_bbs/BBSController?cmd=remove'">
						<input type="button" value="목록으로 이동" onclick="location.href='/chapter20_mvc_bbs/BBSController?cmd=allList&currentPage=${session.currentPage}'">
					</td>
				</tr>
			</tbody>
		</table>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<input type="hidden" value="${cvo.b_idx }" name="b_idx">
