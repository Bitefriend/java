	...
	<div class="wrap">
		...
		<div class = "header-menu">
			<ul>
			  ...
			  <li><a class="home" href="/jspTest/VolController?cmd=volunteer_main">자기소개서</a></li>
			</ul>
		</div>
		<table>
			<thead>
					...
					<c:otherwise>
						<c:forEach var="vo3" items="${list3 }">
							<tr>
								<td>${vo3.v_idx }</td>
								<td>${vo3.v_idx }</td>
								<td><a href="VolController?cmd=vol_write_view&v_idx=${vo3.v_idx }">${vo3.vtitle1 }</a></td>
								<td>${vo3.vreg_date }</td>
								<td>${vo3.hit }</td>
							</tr>
						</c:forEach>
