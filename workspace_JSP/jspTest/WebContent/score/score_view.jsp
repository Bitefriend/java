	...
	<h2>${svo.ss_idx }의 성적</h2>
		...
		<table>
			<tbody>
				...
				<tr>
					<th>과목</th>
					<td colspan="3">${svo.subName }</td>
				</tr>
				<tr>
					<th>중간고사</th>
					<td colspan="3">${svo.sub1 }</td>
				</tr>
				<tr>
					<th>기말고사</th>
					<td colspan="3">${svo.sub2 }</td>
				</tr>
				<tr>
					<th>과제</th>
					<td colspan="3">${svo.sub3 }</td>
				</tr>
				<tr>
					<th>발표</th>
					<td colspan="3">${svo.sub4 }</td>
				</tr>
				<tr>
					<th>평균</th>
					<td colspan="3">${svo.avg }</td>
				</tr>
				<tr>
					<td colspan="4" id = "btn">
						<input type="button" value="성적 삭제" onclick="location.href='/jspTest/ScoreController?cmd=remove'">
						<input type="button" value="목록으로 이동" onclick="location.href='/jspTest/ScoreController?cmd=score_allList&currentPage=${session.currentPage}'">
						<td> <input type="button" value="수정하기" onclick="update_insert2(this.form)"></td>
		...
		<!-- 댓글 입력 폼 -->
		 <form method="post">
			...
			<input type="hidden" name="b_idx" value="${bvo.s_idx }">
