...
<body>
	<c:set value="12345567890.1234567809" var="n" />
	<h3>formatNumber의 groupingUsed</h3>
	천 단위 구분 기호 + 소수 3 자리 : <fmt:formatNumber value="${n }"/> <br>
	천 단위 구분 기호없이 소수 3 자리 : <fmt:formatNumber value="${n }" groupingUsed="no" /> <br>
	
	<hr>
	
	<h3>formarNumber의 pattern</h3>
	천단위 구분 기호 + 소수 2 자리 : <fmt:formatNumber value="${n}" pattern="#,##0.00" /><br>
	천단위 구분 기호 + 정수 : <fmt:formatNumber value="${n}" pattern="#,000" /><br>
